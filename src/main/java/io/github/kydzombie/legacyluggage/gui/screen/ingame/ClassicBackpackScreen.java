...
import io.github.kydzombie.legacyluggage.gui.screen.ClassicBackpackScreenHandler;
import io.github.kydzombie.legacyluggage.inventory.BagInventory;
import net.minecraft.client.gui.screen.ingame.HandledScreen;
import net.minecraft.entity.player.PlayerInventory;
import org.lwjgl.opengl.GL11;

public class ClassicBackpackScreen extends HandledScreen {
    // TODO: Support different sizes of backpack
    public ClassicBackpackScreen(PlayerInventory playerInventory, BagInventory backpackInventory) {
        super(new ClassicBackpackScreenHandler(playerInventory, backpackInventory));
    }
